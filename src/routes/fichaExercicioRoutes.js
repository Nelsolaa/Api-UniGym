...
router.post('/register', authMiddleware,FichaExercicioController.createFichaExercicio);

// Obter uma ligação específica Ficha-Exercício pelas suas chaves primárias
router.get('/:fichaId/:exercicioId/search', authMiddleware,FichaExercicioController.getFichaExercicioByPks);
...
router.get('/ficha/:fichaId/getAll', authMiddleware,FichaExercicioController.getExerciciosByFichaId);

// Atualizar os detalhes de uma ligação Ficha-Exercício (series, tempo_descanso)
// Apenas professores podem manipular diretamente
router.put('/:fichaId/:exercicioId/update', authMiddleware,FichaExercicioController.updateFichaExercicioByPks);

// Deletar uma ligação específica Ficha-Exercício
// Apenas professores podem manipular diretamente
router.delete('/:fichaId/:exercicioId/delete', authMiddleware,FichaExercicioController.deleteFichaExercicioByPks);
